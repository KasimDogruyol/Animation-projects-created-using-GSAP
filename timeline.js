...
let tl = gsap.timeline({ 
  defaults: 
    {duration: 2, ease: "power1.inOut", yoyo: true, repeat: -1} //yoyo parametresi burda true ara doldurmanın ileri ve geri gitmesine neden olur
    // her tekrarda geri ve ileri değişir
})
